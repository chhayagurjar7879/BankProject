...
public class accountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Accounty: " + acno + "</h1>");
            out.println("<h1>Name: " + cname + "</h1>");
            out.println("<h1>Balance: " + balance + "</h1>");
            out.println("<h1>Username: " + un + "</h1>");
            out.println("<h1>Password: " +ps+ "</h1>");

            AccountBean ac = new AccountBean();
            ac.setAcount_num(acno);
            ac.setCustomer_name(cname);
